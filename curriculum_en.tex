...
\begin{resume_section}{Work Experience}
	...
	\begin{resume_subsection}[Sao Paulo, SP (2021.08 -- present)]{BRASA -- Back End Developer}
		I am currently working on the development team for BRASA. I built a Linktree like application for the organization's members using Firebase and React. I also developed the back-end for a messaging notification system with Express. 
...
\begin{resume_section}{Education}
  ...
  \begin{resume_subsection}[]{Relevant Coursework}
	...
	\begin{subitems}
		...
		\item Programming in C (Purdue CS 240) -- Fall 2020
	\end{subitems}  	
