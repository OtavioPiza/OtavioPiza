...
\begin{resume_section}{Personal Projects}
	...
	\begin{resume_subsection}{Project Euler 100 -- \href{https://www.github.com/OtavioPiza/project-euler}{github.com/OtavioPiza/project-euler}}
		I created this project to give people insight into the design process of efficient algorithms, iterating through many possible solutions: explaining their strengths and weaknesses. The project consists of a series of Jupyter Notebooks where all my logic is explained. I am currently studying possibilities to host them online. 
	\end{resume_subsection}
