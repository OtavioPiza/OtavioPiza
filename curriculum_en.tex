...
\begin{resume_section}{About Me}
  ...
  \begin{nospacetabbing}
  	\textbf{Technical Skills}  \= C/C++, Python, Jupyter Notebooks, TypeScript, JavaScript, Java,  Bash, SQL, R, \LaTeX. \\*
  	...
  	\textbf{Interests} \> Analysis of Algorithms, Systems Programming, Computer Networks, Security, Databases.\\*
  \end{nospacetabbing}
...
\begin{resume_section}{Work Experience}
	...
	\begin{resume_subsection}[(2022.05 -- 2022.08)]{Google -- STEP Intern}
		\begin{subitems}

		\end{subitems}
	\end{resume_subsection}\item

	\begin{resume_subsection}[(2021.08 -- present)]{BRASA -- Back End Developer}
		\begin{subitems}
